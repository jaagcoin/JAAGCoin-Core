# Linearize
Construct a linear, no-fork, best version of the Jaag blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install jaag_hash

https://github.com/jaagpay/jaag_hash
...
JSON-RPC server. Running `jaagd` or `jaag-qt -server` will be sufficient.
...
* `input`: jaagd blocks/ directory containing blkNNNNN.dat
