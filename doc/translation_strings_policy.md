...
This document provides guidelines for internationalization of the Jaag Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `jaag_en.ts` remains unchanged.
