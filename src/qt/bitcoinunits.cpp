...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(JAAG);
    unitlist.append(mJAAG);
    unitlist.append(uJAAG);
...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            ...
            case mJAAG: return QString("mJAAG");
            case uJAAG: return QString::fromUtf8("μJAAG");
    ...
    else
    {
        switch(unit)
        {
            case JAAG: return QString("tJAAG");
            case mJAAG: return QString("mtJAAG");
            case uJAAG: return QString::fromUtf8("μtJAAG");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case JAAG:  return 100000000;
    case mJAAG: return 100000;
    case uJAAG: return 100;
    case duffs: return 1;
