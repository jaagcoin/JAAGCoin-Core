    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("JAAG-light"), QVariant("light"));
    ui->theme->addItem(QString("JAAG-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("JAAG-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("JAAG-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("JAAG-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("JAAG-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("JAAG-traditional"), QVariant("trad"));
