...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Jaag related functionality
...
/*
    ...
    allow endless transaction that would bloat Jaag and make it unusable. To
