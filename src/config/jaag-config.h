/* src/config/jaag-config.h.  Generated from jaag-config.h.in by configure.  */
/* src/config/jaag-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef JAAG_CONFIG_H

#define JAAG_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Jaag Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Jaag Core"
...
#define PACKAGE_BUGREPORT "https://github.com/jaagpay/jaag/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Jaag Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Jaag Core 0.12.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "jaagcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://jaag.org/"
