...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in jaag.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("jaag.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Jaag features */
    { "jaag",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "jaag",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "jaag",               "gobject",                &gobject,                true,  {} },
    { "jaag",               "voteraw",                &voteraw,                true,  {} },
