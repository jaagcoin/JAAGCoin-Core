...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Jaag address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "jaag",               "masternode",             &masternode,             true,  {} },
    { "jaag",               "masternodelist",         &masternodelist,         true,  {} },
    { "jaag",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "jaag",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "jaag",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "jaag",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
